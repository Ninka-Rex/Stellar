...
void AppSettings::load() {
    ...
    emit showSearchEngineChanged();
    emit showRssReaderChanged();
...
void AppSettings::setEstimatedOnlineUsersInStatusBar(bool v) {
    if (m_estimatedOnlineUsersInStatusBar != v) {
        m_estimatedOnlineUsersInStatusBar = v;
        emit estimatedOnlineUsersInStatusBarChanged();
        save();
    }
}
...
void AppSettings::setShowSearchEngine(bool v)        { if (m_showSearchEngine        != v) { m_showSearchEngine        = v; emit showSearchEngineChanged();        save(); } }
void AppSettings::setShowRssReader(bool v)           { if (m_showRssReader           != v) { m_showRssReader           = v; emit showRssReaderChanged();           save(); } }
